import { w as getDefaultExportFromCjs, L as jsxRuntimeExports, P as notFound } from "./server-ASaDeMZs.js";
import { R as Route, e as useQuery, L as Link } from "./router-CO9yg4eA.js";
...
function ArticlePage() {
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container-prose py-24 text-muted-foreground", children: "Loading…" });
  }
  if (error || !data) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose py-24 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-2xl text-primary", children: "Article not found" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/news", className: "mt-6 inline-flex text-sm text-secondary hover:underline", children: "← Back to News" })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("article", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "relative overflow-hidden bg-primary text-primary-foreground", children: [
      data.cover_image_url && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: data.cover_image_url, alt: "", className: "absolute inset-0 h-full w-full object-cover" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-r from-primary/80 via-primary/60 to-primary/40" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose relative py-20 md:py-28", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/news", className: "inline-flex items-center gap-1 text-xs text-primary-foreground/80 hover:text-secondary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "h-3.5 w-3.5" }),
          " News & Articles"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "mt-4 text-3xl md:text-5xl", children: data.title }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-4 text-sm text-primary-foreground/80", children: [
          "By ",
          data.author_name,
          data.published_at && " · " + new Date(data.published_at).toLocaleDateString("en-ZA", {
            year: "numeric",
            month: "long",
            day: "numeric"
          })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "container-prose py-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-auto max-w-3xl space-y-5 text-base leading-relaxed text-foreground/90 [&_h1]:mt-10 [&_h1]:text-3xl [&_h1]:text-primary [&_h2]:mt-8 [&_h2]:text-2xl [&_h2]:text-primary [&_h3]:mt-6 [&_h3]:text-xl [&_h3]:text-primary [&_a]:text-secondary [&_a]:underline [&_ul]:list-disc [&_ul]:pl-6 [&_ol]:list-decimal [&_ol]:pl-6 [&_strong]:text-primary [&_blockquote]:border-l-4 [&_blockquote]:border-secondary [&_blockquote]:pl-4 [&_blockquote]:italic [&_code]:rounded [&_code]:bg-muted [&_code]:px-1 [&_img]:rounded-sm", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Markdown, { children: data.content }) }) })
  ] });
}
export {
