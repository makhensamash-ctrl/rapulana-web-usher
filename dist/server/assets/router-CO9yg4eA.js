import { W as reactExports, H as isPromise, I as isRedirect, G as isNotFound, B as invariant, f as createControlledPromise, a2 as rootRouteId, J as isServer$1, u as functionalUpdate$1, a as arraysEqual, g as createLRUCache, d as compileDecodeCharMap, a4 as trimPath, a1 as rewriteBasepath, e as composeRewrites, V as processRouteTree, U as processRouteMasks, a0 as resolvePath, c as cleanPath, a6 as trimPathRight, S as parseHref, p as executeRewriteInput, C as isDangerousProtocol, X as redirect, t as findSingleMatch, k as deepEqual, D as DEFAULT_PROTOCOL_ALLOWLIST, b as buildRouteBranch, A as interpolatePath, Q as nullReplaceEqualDeep, Z as replaceEqualDeep$1, M as last, j as decodePath, r as findFlatMatch, s as findRouteMatch, z as hasKeys, q as executeRewriteOutput, m as encodePathLikeUrl, a5 as trimPathLeft, K as joinPaths, a8 as useRouter, l as dummyMatchContext, N as matchContext, _ as requireReactDom, o as exactPathTest, Y as removeTrailingSlash, R as React, L as jsxRuntimeExports, F as isModuleNotFoundError, a7 as useHydrated, n as escapeHtml, E as isInlinableStylesheet, v as getAssetCrossOrigin, $ as resolveManifestAssetLink, O as Outlet } from "./server-ASaDeMZs.js";
...
const appCss = "/assets/styles-CtzrE6y2.css";
...
const logoDark = "/assets/logo-transparent-DsXPb3Hg.png";
function LatestArticleBanner() {
  const { data } = useQuery({
    queryKey: ["latest-blog-banner"],
    queryFn: async () => {
      const { data: data2, error } = await supabase.from("blogs").select("title, slug, published_at").eq("published", true).order("published_at", { ascending: false }).limit(1).maybeSingle();
      if (error) throw error;
      return data2;
    },
    staleTime: 6e4
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative w-full overflow-hidden border-b border-primary/20 bg-primary text-primary-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    Link,
    {
      to: "/news/$slug",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex shrink-0 items-center gap-2 border-r border-primary-foreground/20 px-4 text-[11px] font-semibold uppercase tracking-widest text-secondary", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Newspaper, { className: "h-3.5 w-3.5" }),
          "New"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative flex-1 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex w-max animate-marquee gap-16 whitespace-nowrap pr-16 text-sm font-medium group-hover:[animation-play-state:paused]", children: Array.from({ length: 2 }).map((_, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-90", children: text }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-secondary underline-offset-4 group-hover:underline", children: "Read article →" })
        ] }, i)) }) })
      ]
    }
  ) });
...
function SiteHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "sticky top-0 z-40 border-b border-border/60 bg-background/85 backdrop-blur", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(LatestArticleBanner, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose flex h-28 items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "flex items-center gap-3", "aria-label": "Rapulana Attorneys home", children: /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoDark, alt: "Rapulana Attorneys logo", className: "h-20 w-auto md:h-24" }) }),
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border md:hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose flex flex-col gap-4 py-6", children: [
      links.map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/",
...
const logoLight = "/assets/logo-light-6C1RhOnE.jpeg";
function SiteFooter() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "mt-24 border-t border-border bg-primary text-primary-foreground", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose grid gap-12 py-16 md:grid-cols-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: logoLight, alt: "Rapulana Attorneys logo", className: "h-20 w-auto rounded-sm" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 max-w-sm text-sm text-primary-foreground/70", children: "A boutique South African law firm built on integrity, precision, and decades of combined courtroom experience." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow mb-4 text-gold", children: "Explore" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-primary-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", hash: "about", className: "hover:text-gold", children: "About" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", hash: "services", className: "hover:text-gold", children: "Services" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", hash: "team", className: "hover:text-gold", children: "Team" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", hash: "contact", className: "hover:text-gold", children: "Contact" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/booking", className: "hover:text-gold", children: "Book Consultation" }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "eyebrow mb-4 text-gold", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-2 text-sm text-primary-foreground/80", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "1st Floor, HQ Hatfield" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "353 Festival Street" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Pretoria" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "073 989 7286" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "info@rapulana.co.za" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-primary-foreground/10", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container-prose flex flex-col items-center justify-between gap-2 py-6 text-xs text-primary-foreground/60 md:flex-row", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
        "© ",
        (/* @__PURE__ */ new Date()).getFullYear(),
        " Rapulana Attorneys Inc. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Admitted attorneys of the High Court of South Africa." })
    ] }) })
  ] });
}
...
const $$splitComponentImporter$c = () => import("./news-BZHpDzA6.js");
const Route$c = createFileRoute("/news")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Insights, updates and legal perspectives from Rapulana Attorneys."
    }, {
      property: "og:title",
      content: "News & Articles — Rapulana Attorneys"
    }, {
...
const $$splitComponentImporter$b = () => import("./login-NheYR8Vc.js");
const Route$b = createFileRoute("/login")({
  head: () => ({
    meta: [{
      title: "Sign in — Rapulana Attorneys"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./change-password-Dyye0zqJ.js");
const Route$a = createFileRoute("/change-password")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./booking-BRhrgaXW.js");
const Route$9 = createFileRoute("/booking")({
  head: () => ({
    meta: [{
      title: "Book a Consultation — Rapulana Attorneys"
    }, {
      name: "description",
      content: "Schedule a consultation with Rapulana Attorneys. Pick a date and time that suits you."
    }, {
      property: "og:title",
      content: "Book a Consultation — Rapulana Attorneys"
    }, {
      property: "og:description",
      content: "Schedule a one-hour consultation with Rapulana Attorneys."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./_authenticated-BDSN1wgX.js");
const Route$8 = createFileRoute("/_authenticated")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./index-E_iWqlS-.js");
const Route$7 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Boutique South African law firm. Corporate, commercial, family and litigation services delivered by senior attorneys."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./news_._slug-CO-i0o8Q.js");
const Route$6 = createFileRoute("/news_/$slug")({
  head: ({
    params
  }) => ({
    meta: [{
...
const $$splitComponentImporter$5 = () => import("./admin-L2apnAXl.js");
const Route$5 = createFileRoute("/_authenticated/admin")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./index-D9aICvl4.js");
const Route$4 = createFileRoute("/_authenticated/admin/")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./users-Bz3mvxGn.js");
const Route$3 = createFileRoute("/_authenticated/admin/users")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./bookings-B3ukqE1R.js");
const Route$2 = createFileRoute("/_authenticated/admin/bookings")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./blogs-yOD4uXoi.js");
const Route$1 = createFileRoute("/_authenticated/admin/blogs")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./blogs_._id-C6Ija6ni.js");
const Route2 = createFileRoute("/_authenticated/admin/blogs_/$id")({
...
const ChangePasswordRoute = Route$a.update({
  id: "/change-password",
  path: "/change-password",
  getParentRoute: () => Route$e
});
const BookingRoute = Route$9.update({
  id: "/booking",
  path: "/booking",
  getParentRoute: () => Route$e
});
...
const NewsSlugRoute = Route$6.update({
  id: "/news_/$slug",
  path: "/news/$slug",
  getParentRoute: () => Route$e
});
...
const AuthenticatedAdminBookingsRoute = Route$2.update({
  id: "/bookings",
  path: "/bookings",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminBlogsRoute = Route$1.update({
  id: "/blogs",
  path: "/blogs",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminBlogsIdRoute = Route2.update({
  id: "/blogs_/$id",
  path: "/blogs/$id",
  getParentRoute: () => AuthenticatedAdminRoute
});
const AuthenticatedAdminRouteChildren = {
  AuthenticatedAdminBlogsRoute,
  AuthenticatedAdminBookingsRoute,
  AuthenticatedAdminUsersRoute,
  AuthenticatedAdminIndexRoute,
  AuthenticatedAdminBlogsIdRoute
};
